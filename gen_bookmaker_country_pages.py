...
<div class="footer-bar">
  ...
  <a href="{assets}">Home</a> · <a href="{assets}best-bonus-in-{country_slug}/">{cname} Betting</a> · <a href="{assets}bookmakers/{bk_slug}/">{name} Africa Review</a> · <a href="{assets}tips/">Tips</a> · <a href="{assets}blog/">Blog</a> · <a href="{assets}about/">About</a><br>
...
<script src="{assets}assets/shared.js?v=28"></script>
<script>
