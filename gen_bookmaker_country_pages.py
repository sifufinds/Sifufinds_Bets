...
<link rel="preload" href="{assets}assets/shared.css?v=9" as="style">
<link rel="stylesheet" href="{assets}assets/shared.css?v=9">
<style>
...
<script src="{assets}assets/shared.js?v=13"></script>
<script>
