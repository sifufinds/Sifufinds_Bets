...
BRANDS = [
    ...
    # Facts below mirror the same brand's existing verified entry in
    # agent_telegram_offers.py's BRANDS (itself sourced from assets/shared.js's
    # BOOKS entries — already live, verified data — or, for Mebet, from
    # confirming its masked link redirects to melbet.org's own registration
    # page) rather than being re-researched from scratch.
    {
        "name": "Mebet",
        "flag": "🌍",
        "countries": ["Nigeria", "Kenya", "Ghana", "Tanzania", "Ethiopia"],
        "welcome": "200% First Deposit Bonus – Up to ₦480,000",
        "highlight": "150+ sports markets — most in Africa",
        "url": "https://refpa3665.com/L?tag=d_5833716m_66335c_sifufinds&site=5833716&ad=66335",
        "min_deposit": "₦100",
        "licence": "NLRC + BCLB",
        "hashtags": "#Mebet #Africa #200Bonus #SportsBetting",
    },
    {
        "name": "Rasbet",
        "flag": "🇪🇹",
        ...
        "highlight": "Rising sportsbook built for the Ethiopian market",
        "url": "https://rasbet.goaffnk.com/t/MTRfMQ==/",
        "min_deposit": "Br 50",
        "licence": "Licensed",
        "hashtags": "#Rasbet #Ethiopia #SportsBetting",
    },
    {
        "name": "TicTacBets",
        "flag": "🇿🇦",
        ...
        "highlight": "25 free spins on registration, no deposit needed",
        "url": "https://trackrt.tictacbets.co.za/o/zdY0CA?site_id=1023",
        "min_deposit": "R5",
        "licence": "NCGLB",
        "hashtags": "#TicTacBets #SouthAfrica #FreeSpins",
    },
    {
        "name": "BetXchange",
        "flag": "🇿🇦",
        ...
        "highlight": "Betting exchange with competitive odds",
        "url": "https://track.trkbxa.click/o/yDSAGh?lpage=m0gk2w&site_id=1226",
        "min_deposit": "R10",
        "licence": "WCGRB",
        "hashtags": "#BetXchange #SouthAfrica #SportsBetting",
    },
    {
        "name": "Bettabets",
        "flag": "🇿🇦",
        "countries": ["South Africa"],
        "welcome": "R200 Free Bet on First Deposit",
        "highlight": "Local South African brand focused on PSL and cricket",
        "url": "https://track.bettapartners.co.za/o/zNV2Pk?lpage=AjB-aC&site_id=777",
        "min_deposit": "R10",
        "licence": "NGB",
        "hashtags": "#Bettabets #SouthAfrica #PSL",
    },
    {
        "name": "Playbet",
        "flag": "🇿🇦",
        ...
        "highlight": "Sports and casino in one platform",
        "url": "https://trk.playbet.net/o/5tgJzp?site_id=284",
        "min_deposit": "R10",
        "licence": "WCGRB",
        "hashtags": "#Playbet #SouthAfrica #SportsBetting",
    },
    {
        "name": "Linebet",
        "flag": "🌍",
        ...
        "highlight": "100% match on first deposit, wager x5 accumulators at min odds 1.40",
        "url": "https://lb-aff.com/L?tag=d_5966746m_22611c_sifufinds&site=5966746&ad=22611",
        "min_deposit": "₦100",
        "licence": "Curaçao",
        "hashtags": "#Linebet #Africa #SportsBetting",
    },
    {
        "name": "FairPari",
        "flag": "🌍",
        "countries": ["Ghana", "South Africa", "Tanzania", "Uganda", "Zambia"],
        "welcome": "100% First Deposit Bonus – Up to €100",
        "highlight": "63+ sports, 4,000+ casino games, wide payment options",
        ...
        "hashtags": "#FairPari #Africa #SportsBetting",
    },
]
