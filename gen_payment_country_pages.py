...
<div class="footer-bar">
  ...
  <a href="{assets}">Home</a> · <a href="{assets}betting/{pm_slug}/">{pm_name} Betting Africa</a> · <a href="{assets}best-bonus-in-{country_slug}/">{cname} Betting</a> · <a href="{assets}tips/">Tips</a> · <a href="{assets}about/">About</a><br>
