...
{abbr:'BTB',bg:'#1B5E20',tc:'#fff',name:'Bettabets',url:'https://www.bettabets.co.za',tag:'SA Local Brand – PSL & Cricket',off:'R200 Free Bet on First Deposit',top:'R200 Free',stars:3,min:'R10',instant:true,cashout:true,stream:false,sports:20,lic:'NGB Licensed',nodep:false,badge:'',terms:'R200 free bet on first deposit. FICA required. T&Cs. 18+.',pms:['FNB','Standard Bank','Nedbank','Capitec','Instant EFT']}
],
TZ:[
