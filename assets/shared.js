...
{abbr:'BTA',bg:'#FF3C01',tc:'#fff',name:'BetArena Mozambique',url:'https://www.betarena.co.mz',tag:'Mozambique Sports Arena',off:'100% Welcome Bonus',top:'100% Match',stars:3,min:'MT 50',instant:true,cashout:true,stream:false,sports:18,lic:'INAR Licensed',nodep:false,badge:'',terms:'100% match on first deposit. M-Pesa. T&Cs. 18+.',pms:['M-Pesa','e-Mola','Bank Transfer']},
