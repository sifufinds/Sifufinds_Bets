...
// ── COUNTRY EMOJI ──────────────────────────────────────────────────────────────
const CTY_EMOJI={NG:'🇳🇬',KE:'🇰🇪',GH:'🇬🇭',ZA:'🇿🇦',TZ:'🇹🇿',UG:'🇺🇬',ZM:'🇿🇲',ET:'🇪🇹',CI:'🇨🇮',CM:'🇨🇲',SN:'🇸🇳',RW:'🇷🇼',ZW:'🇿🇼',MW:'🇲🇼',MZ:'🇲🇿',AO:'🇦🇴',CD:'🇨🇩',BT:'🇧🇼',NA:'🇳🇦'};
...
const COUNTRY_DATA={
  ...
  ET:{name:'Ethiopia',flag:'🇪🇹',currency:'ETB',symbol:'Br',region:'east',regulator:'National Lottery Administration (NLA)',about:'Ethiopia is a fast-growing betting market with significant restrictions. The National Lottery Administration oversees gambling. Commercial Bank of Ethiopia is the primary banking option. The Ethiopian Premier League is the most-bet local competition.',payments:['Commercial Bank of Ethiopia','Bank Transfer','Visa','Mastercard'],leagues:['Ethiopian Premier League','CAF Confederation Cup','Premier League','AFCON']},
  CI:{name:'Ivory Coast',flag:'🇨🇮',currency:'XOF',symbol:'CFA',region:'west',regulator:'ARJEL CI (Autorité de Régulation des Jeux en Ligne)',about:'Côte d\'Ivoire has a well-established betting market underpinned by Orange Money and the local PMU network. Orange Bet and international operators compete for share. The Ligue 1 CI and CAF competitions dominate wagering.',payments:['Orange Money','MTN MoMo','Wave','Bank Transfer','Visa'],leagues:['Ligue 1 CI','CAF Champions League','Ligue 1 France','Premier League','AFCON']},
  ...
  BT:{name:'Botswana',flag:'🇧🇼',currency:'BWP',symbol:'BWP',region:'south',regulator:'Gambling Authority of Botswana',about:'Botswana has a well-regulated betting market overseen by the Gambling Authority. FNB Botswana and Orange Money Botswana are the main payment channels. The Botswana Premier League and South African PSL attract most bettors.',payments:['FNB Botswana','Orange Money Botswana','Bank Transfer','Visa','Mastercard'],leagues:['Botswana Premier League','CAF Confederation Cup','DStv Premiership','Premier League']},
...
{abbr:'BB',bg:'#1C1E24',tc:'#f9c633',name:'Bangbet Nigeria',url:'https://www.bangbet.com',tag:'Low Minimum Stake – Great for Beginners',off:'Deposit ₦50, Get ₦200 in Free Bets',top:'₦200 Free',stars:3,min:'₦50',instant:true,cashout:false,stream:false,sports:20,lic:'NLRC Licensed',nodep:false,badge:'',terms:'Deposit ₦50 minimum and receive ₦200 in free bets. 7-day expiry. T&Cs. 18+.',pms:['OPay','Bank Transfer','Visa','Mastercard']},
...
{abbr:'BTB',bg:'#1B5E20',tc:'#fff',name:'Betta Bets',url:'https://www.bettabets.co.za',tag:'South African Local Brand',off:'R200 Free Bet on First Deposit',top:'R200 Free',stars:3,min:'R10',instant:true,cashout:true,stream:false,sports:20,lic:'NGB Licensed',nodep:false,badge:'',terms:'R200 free bet on first deposit. FICA required. Min odds 1.50. T&Cs. 18+.',pms:['FNB','Standard Bank','Nedbank','Capitec','Instant EFT']},
...
{abbr:'BX',bg:'#0D47A1',tc:'#fff',name:'BetXchange',url:'https://www.betxchange.co.za',tag:'SA Betting Exchange – Competitive Odds',off:'R200 Free Bet on First Deposit',top:'R200 Free',stars:4,min:'R10',instant:true,cashout:true,stream:false,sports:22,lic:'WCGRB Licensed',nodep:false,badge:'',terms:'R200 free bet on first deposit. FICA required. Wagering requirements apply. T&Cs. 18+.',pms:['FNB','Standard Bank','Nedbank','Capitec','Visa','Mastercard','Instant EFT']},
...
ET:[
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Ethiopia',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'Ethiopia\'s Largest Online Bookmaker',off:'200% First Deposit Bonus – Up to Br 10,000',top:'Br 10,000',stars:5,min:'Br 50',instant:true,cashout:true,stream:true,sports:50,lic:'NLA Licensed',nodep:false,badge:'hot',terms:'200% match up to Br 10,000. Wager x5 at min odds 1.40. 30 days. T&Cs. 18+.',pms:['Commercial Bank of Ethiopia','Bank Transfer','Visa','Mastercard']},
{abbr:'SB',bg:'#007A4D',tc:'#fff',name:'SportSbet Ethiopia',url:'https://www.sportsbet.com.et',tag:'Leading Local Ethiopian Brand',off:'100% Welcome Bonus on First Deposit',top:'100% Match',stars:4,min:'Br 50',instant:true,cashout:true,stream:false,sports:20,lic:'NLA Licensed',nodep:false,badge:'',terms:'100% match on first deposit. Commercial Bank of Ethiopia. T&Cs. 18+.',pms:['Commercial Bank of Ethiopia','Bank Transfer']},
{abbr:'BW',bg:'#00aeef',tc:'#000',name:'Betway Ethiopia',url:'https://www.betway.com',tag:'International Brand – EPL & AFCON',off:'50% Welcome Bonus – Up to Br 5,000',top:'Br 5,000',stars:4,min:'Br 100',instant:true,cashout:true,stream:true,sports:28,lic:'NLA Licensed',nodep:false,badge:'new',terms:'50% match up to Br 5,000. Bank transfer. Wager 3x. T&Cs. 18+.',pms:['Commercial Bank of Ethiopia','Bank Transfer','Visa','Mastercard']}
],
CI:[
{abbr:'PMU',bg:'#003580',tc:'#fff',name:'PMU Côte d\'Ivoire',url:'https://www.pmu.ci',tag:'State-Backed – Retail & Online',off:'Bonus de Bienvenue – 100% jusqu\'à CFA 50,000',top:'CFA 50,000',stars:5,min:'CFA 200',instant:true,cashout:true,stream:false,sports:20,lic:'ARJEL Licensed',nodep:false,badge:'hot',terms:'100% match up to CFA 50,000 on first deposit. Orange Money accepted. T&Cs. 18+.',pms:['Orange Money','MTN MoMo','Wave','Bank Transfer']},
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Côte d\'Ivoire',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'200% Bonus – Highest in Ivory Coast',off:'200% First Deposit Bonus – Up to CFA 200,000',top:'CFA 200,000',stars:4,min:'CFA 200',instant:true,cashout:true,stream:true,sports:50,lic:'ARJEL Licensed',nodep:false,badge:'',terms:'200% match up to CFA 200,000. Wager x5. Min odds 1.40. 30 days. T&Cs. 18+.',pms:['Orange Money','MTN MoMo','Wave','Visa','Mastercard']},
{abbr:'BW',bg:'#00aeef',tc:'#000',name:'Betway CI',url:'https://www.betway.com',tag:'International Brand – Ligue 1 CI',off:'50% Welcome Bonus – Up to CFA 100,000',top:'CFA 100,000',stars:4,min:'CFA 500',instant:true,cashout:true,stream:true,sports:28,lic:'ARJEL Licensed',nodep:false,badge:'new',terms:'50% match up to CFA 100,000. Orange Money. Wager 3x. T&Cs. 18+.',pms:['Orange Money','MTN MoMo','Bank Transfer','Visa']},
{abbr:'OB',bg:'#FF6B00',tc:'#fff',name:'Orange Bet CI',url:'https://www.orangebet.ci',tag:'Orange Money Instant Deposits',off:'100% Bonus on First Deposit',top:'100% Match',stars:3,min:'CFA 200',instant:true,cashout:false,stream:false,sports:18,lic:'ARJEL Licensed',nodep:false,badge:'',terms:'100% match on first deposit via Orange Money. T&Cs. 18+.',pms:['Orange Money','Bank Transfer']}
],
CM:[
{abbr:'PMU',bg:'#003580',tc:'#fff',name:'PMU Cameroun',url:'https://www.pmu.cm',tag:'State-Backed – Retail Shops & Online',off:'100% Bonus de Bienvenue – jusqu\'à CFA 50,000',top:'CFA 50,000',stars:5,min:'CFA 200',instant:true,cashout:true,stream:false,sports:20,lic:'AMJ Licensed',nodep:false,badge:'hot',terms:'100% match up to CFA 50,000. Orange Money and MTN MoMo. T&Cs. 18+.',pms:['Orange Money','MTN MoMo','Bank Transfer']},
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Cameroun',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'200% Bonus – Elite One & AFCON',off:'200% First Deposit Bonus – Up to CFA 200,000',top:'CFA 200,000',stars:4,min:'CFA 200',instant:true,cashout:true,stream:true,sports:50,lic:'AMJ Licensed',nodep:false,badge:'',terms:'200% match up to CFA 200,000. Wager x5. Min odds 1.40. 30 days. T&Cs. 18+.',pms:['Orange Money','MTN MoMo','Visa','Mastercard']},
{abbr:'BW',bg:'#00aeef',tc:'#000',name:'Betway Cameroun',url:'https://www.betway.com',tag:'International Brand in Cameroon',off:'50% Welcome Bonus – Up to CFA 100,000',top:'CFA 100,000',stars:4,min:'CFA 500',instant:true,cashout:true,stream:true,sports:28,lic:'AMJ Licensed',nodep:false,badge:'new',terms:'50% match up to CFA 100,000. Orange Money. T&Cs. 18+.',pms:['Orange Money','MTN MoMo','Bank Transfer','Visa']}
],
SN:[
...
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Sénégal',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'200% Bonus – Ligue 1 SN & AFCON',off:'200% First Deposit Bonus – Up to CFA 200,000',top:'CFA 200,000',stars:4,min:'CFA 200',instant:true,cashout:true,stream:true,sports:50,lic:'ARTP Licensed',nodep:false,badge:'',terms:'200% match up to CFA 200,000. Wager x5. Min odds 1.40. 30 days. T&Cs. 18+.',pms:['Orange Money','Wave','MTN MoMo','Visa','Mastercard']},
{abbr:'OB',bg:'#FF6B00',tc:'#fff',name:'Orange Bet Sénégal',url:'https://www.orangebet.sn',tag:'Orange Money Instant – Local Brand',off:'100% Bonus on First Deposit',top:'100% Match',stars:3,min:'CFA 200',instant:true,cashout:false,stream:false,sports:18,lic:'ARTP Licensed',nodep:false,badge:'',terms:'100% match on first deposit. Orange Money only. T&Cs. 18+.',pms:['Orange Money','Bank Transfer']}
],
RW:[
{abbr:'BW',bg:'#00aeef',tc:'#000',name:'Betway Rwanda',url:'https://www.betway.co.rw',tag:'Rwanda\'s #1 Licensed Bookmaker',off:'50% Welcome Bonus – Up to RWF 50,000',top:'RWF 50,000',stars:5,min:'RWF 500',instant:true,cashout:true,stream:true,sports:28,lic:'RGC Licensed',nodep:false,badge:'hot',terms:'50% match up to RWF 50,000. MTN MoMo Rwanda and Airtel Money Rwanda. Wager 3x. T&Cs. 18+.',pms:['MTN MoMo Rwanda','Airtel Money Rwanda','Bank Transfer','Visa']},
{abbr:'SP',bg:'#00BF5C',tc:'#fff',name:'SportPesa Rwanda',url:'https://www.sportpesa.rw',tag:'Jackpot Brand – RPL Coverage',off:'200% Karibu Gift on First Deposit',top:'200% Match',stars:4,min:'RWF 200',instant:true,cashout:true,stream:false,sports:20,lic:'RGC Licensed',nodep:false,badge:'',terms:'200% Karibu Gift on first deposit. MTN MoMo Rwanda. T&Cs. 18+.',pms:['MTN MoMo Rwanda','Airtel Money Rwanda','Bank Transfer']},
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Rwanda',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'200% Bonus – 50+ Sports',off:'200% First Deposit Bonus – Up to RWF 200,000',top:'RWF 200,000',stars:4,min:'RWF 500',instant:true,cashout:true,stream:true,sports:50,lic:'RGC Licensed',nodep:false,badge:'',terms:'200% match up to RWF 200,000. Wager x5. Min odds 1.40. 30 days. T&Cs. 18+.',pms:['MTN MoMo Rwanda','Airtel Money Rwanda','Visa','Mastercard']}
],
ZW:[
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Zimbabwe',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'Highest Bonus in Zimbabwe – 200%',off:'200% First Deposit Bonus – Up to $200',top:'$200',stars:4,min:'$1',instant:true,cashout:true,stream:true,sports:50,lic:'LGB Zimbabwe',nodep:false,badge:'hot',terms:'200% match up to $200. Wager x5 at min odds 1.40. 30 days. EcoCash accepted. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Visa','Mastercard']},
{abbr:'BN',bg:'#0055A4',tc:'#fff',name:'BetWinner Zimbabwe',url:'https://bwredir.com/1Lvf?p=%2Fregistration%2F',tag:'200% Bonus – 40+ Sports Markets',off:'200% First Deposit Bonus – Up to $130',top:'$130',stars:4,min:'$1',instant:true,cashout:true,stream:true,sports:40,lic:'LGB Zimbabwe',nodep:false,badge:'',terms:'Code WBONUS1. 200% match up to $130. Wager x5 at min odds 1.40. 30 days. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Visa','Mastercard']},
{abbr:'MB',bg:'#FD1B26',tc:'#fff',name:'Melbet Zimbabwe',url:'https://refpa3665.com/L?tag=d_3805306m_61559c_&site=3805306&ad=61559',tag:'200% Bonus – 150+ Sports Markets',off:'200% First Deposit Bonus – Up to $250',top:'$250',stars:4,min:'$1',instant:true,cashout:false,stream:true,sports:150,lic:'LGB Zimbabwe',nodep:false,badge:'',terms:'Code MBMAX. 200% match up to $250. Wager x5 at min odds 1.40. 30 days. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Visa','Mastercard']},
{abbr:'PP',bg:'#2E7D32',tc:'#fff',name:'Paripesa Zimbabwe',url:'https://combodef.com/L?tag=d_2350859m_45569c_&site=2350859&ad=45569',tag:'200% Bonus – 50+ Sports Markets',off:'200% First Deposit Bonus – Up to $200',top:'$200',stars:4,min:'$1',instant:true,cashout:true,stream:true,sports:50,lic:'LGB Zimbabwe',nodep:false,badge:'new',terms:'200% match on first deposit up to $200. Wager x5 at min odds 1.40. 30 days. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Visa','Mastercard']},
{abbr:'HW',bg:'#3B1EA5',tc:'#fff',name:'Hollywoodbets Zimbabwe',url:'https://www.hollywoodbets.net',tag:'South Africa\'s Biggest Brand – In Zimbabwe',off:'$5 Free Bet on Registration',top:'$5 Free Bet',stars:5,min:'$1',instant:true,cashout:true,stream:true,sports:28,lic:'LGB Zimbabwe',nodep:true,badge:'',terms:'$5 free bet after registration and FICA. Min odds 0.5. 24-hour expiry. EcoCash accepted. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Bank Transfer','Visa']},
{abbr:'BW',bg:'#00aeef',tc:'#000',name:'Betway Zimbabwe',url:'https://www.betway.co.zw',tag:'International Brand – PSL & EPL',off:'50% Welcome Bonus – Up to $50',top:'$50',stars:4,min:'$1',instant:true,cashout:true,stream:true,sports:28,lic:'LGB Zimbabwe',nodep:false,badge:'',terms:'50% match up to $50. EcoCash and OneMoney. Wager 3x. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Bank Transfer','Visa']},
{abbr:'SUN',bg:'#001435',tc:'#FFAB09',name:'SunBet Zimbabwe',url:'https://www.sunbet.co.zw',tag:'Casino-Backed – Retail & Online',off:'$10 Free Bet on Signup',top:'$10 Free',stars:4,min:'$1',instant:true,cashout:true,stream:false,sports:20,lic:'LGB Zimbabwe',nodep:true,badge:'',terms:'$10 free bet on registration. EcoCash. Min odds 1.50. T&Cs. 18+.',pms:['EcoCash (Econet)','OneMoney (NetOne)','Bank Transfer']},
...
{abbr:'1X',bg:'#E60000',tc:'#fff',name:'1xBet Casino',url:'https://reffpa.com/L?tag=d_3805082m_97c_&site=3805082&ad=97',tag:'3,000+ Slots – Live Dealers – Africa-Wide',off:'200% Casino Welcome Bonus',top:'200% Match',stars:4,min:'₦100',live:true,jackpot:true,slots:true,nodep:false,badge:'',terms:'200% match on first casino deposit. Wager x35. 30 days. 18+.'},
{abbr:'MB',bg:'#FD1B26',tc:'#fff',name:'Melbet Casino',url:'https://refpa3665.com/L?tag=d_3805306m_61559c_&site=3805306&ad=61559',tag:'2,000+ Games – Mobile-First Casino',off:'100% Casino Bonus – Up to $200',top:'$200',stars:4,min:'₦100',live:true,jackpot:true,slots:true,nodep:false,badge:'',terms:'100% match on first casino deposit. Wager x35. 30 days. T&Cs. 18+.'},
...
<p>SifuFinds is Africa's leading independent betting comparison platform, providing verified bonus information, live odds, free tips, and country-specific bookmaker reviews across 19 African countries.</p>
<h2>Our Mission</h2>
...
<h2>What We Cover</h2>
<div class="cg"><div class="cc"><h3>🏆 Best Bonuses</h3><p>Verified welcome bonuses, no-deposit offers, and free bets from licensed bookmakers.</p></div><div class="cc"><h3>💡 Free Tips</h3><p>Daily expert predictions and AI-powered tips for African and international football.</p></div><div class="cc"><h3>📊 Live Odds</h3><p>Real-time odds comparison across CAF CL, AFCON, EPL, and local leagues.</p></div><div class="cc"><h3>🌍 Countries</h3><p>19 African countries covered with local currency, payment methods, and licensed operators.</p></div></div>
...
<p>SifuFinds reaches over 500,000 monthly visitors across 19 African markets. Our audience are active sports bettors looking for the best bonuses and bookmakers.</p>
...
// Clearbit Logo API shut down Dec 2025. Now uses Google S2 Favicons (always correct, square).
// Upgrade: get a free Logo.dev token at logo.dev/signup and paste it in LOGO_DEV_TOKEN for
// full-resolution transparent logos on all brands.
const LOGO_DEV_TOKEN='';
const logoUrl=url=>{try{const d=new URL(url).hostname.replace(/^www\./,'');if(LOGO_DEV_TOKEN)return`https://img.logo.dev/${d}?token=${LOGO_DEV_TOKEN}&size=128&format=png`;return`https://www.google.com/s2/favicons?domain=${d}&sz=128`;}catch(e){return '';}};
const logoImg=(url,name,abbr,tc,w,r)=>{const word=name.split(' ')[0];const fs=word.length>7?Math.max(9,Math.floor(w*0.22)):Math.floor(w*0.28);return`<span style="color:${tc};font-size:${fs}px;font-weight:900;letter-spacing:-0.5px;text-transform:lowercase;line-height:1;text-align:center;padding:0 2px;position:absolute;inset:0;display:flex;align-items:center;justify-content:center">${word}</span><img src="${logoUrl(url)}" alt="" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;padding:4px;border-radius:${r}px" loading="lazy" onload="this.previousElementSibling.style.visibility='hidden'" onerror="this.style.display='none'">`;};

// ── COUNTRY MANAGEMENT ────────────────────────────────────────────────────────
const _SUPPORTED_CTYS=new Set(['NG','KE','GH','ZA','TZ','UG','ZM','ET','CI','CM','SN','RW','ZW','MW','MZ','AO','CD','BT','NA']);
const _CTY_LS='sf_cty';

// Fire geo-IP request immediately so it resolves in parallel with page render.
// Only runs on first visit (nothing saved yet). Capped at 2 s so init() never hangs.
const _geoFetch=(()=>{
  if(localStorage.getItem(_CTY_LS)||new URLSearchParams(location.search).get('cty'))return null;
...
function syncCountryUI(){
  ...
  // If a URL param is present, keep localStorage in sync (e.g. shared links)
  const urlCty=new URLSearchParams(window.location.search).get('cty');
  if(urlCty) localStorage.setItem(_CTY_LS,urlCty);
...
// Resolves the visitor's country from geo-IP on first visit and saves it.
// Always writes something to localStorage so the fetch never repeats next visit.
