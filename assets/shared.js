...
{abbr:'HLN',bg:'#B71C1C',tc:'#fff',name:'Helabet Nigeria',url:'https://www.helabet.com',tag:'100+ Live Markets Daily',off:'100% Welcome Bonus Up to ₦25,000',top:'₦25,000',stars:3,min:'₦200',instant:true,cashout:true,stream:false,sports:25,lic:'NLRC Licensed',nodep:false,badge:'',terms:'100% match up to ₦25,000. T&Cs. 18+.',pms:['OPay','Bank Transfer','Visa','Mastercard']},
...
{abbr:'BBU',bg:'#263238',tc:'#fff',name:'BetBureau',url:'https://www.betbureau.co.ke',tag:'Bureau of Best Odds in Kenya',off:'100% First Deposit Bonus',top:'100% Match',stars:3,min:'KSh 10',instant:true,cashout:true,stream:false,sports:18,lic:'BCLB Licensed',nodep:false,badge:'',terms:'100% match on first deposit. M-Pesa. T&Cs. 18+.',pms:['M-Pesa','Airtel Money']},
...
{abbr:'BT',bg:'#007A4D',tc:'#fff',name:'Betika Ghana',url:'https://www.betika.com/en-gh/',tag:"Kenya's #1 Brand – Expanded to Ghana",off:'Free Bet Gifts + GPL Markets',top:'Free Bets',stars:4,min:'GH₵2',instant:true,cashout:true,stream:false,sports:20,lic:'GCA Licensed',nodep:true,badge:'new',terms:'Register and verify. Free bet on signup. MTN MoMo. T&Cs. 18+.',pms:['MTN MoMo','Vodafone Cash','AirtelTigo Money','Visa']},
...
{abbr:'BB',bg:'#1C1E24',tc:'#f9c633',name:'Bangbet Tanzania',url:'https://www.bangbet.com',tag:'Low Minimum – TPL Markets',off:'Deposit TSh 1,000 Get TSh 5,000 Free',top:'TSh 5,000',stars:3,min:'TSh 1,000',instant:true,cashout:false,stream:false,sports:20,lic:'GBT Licensed',nodep:false,badge:'',terms:'Low stakes offer on first deposit. M-Pesa. T&Cs. 18+.',pms:['M-Pesa (Vodacom)','Airtel Money','Tigo Pesa']},
...
{abbr:'HLT',bg:'#B71C1C',tc:'#fff',name:'Helabet Tanzania',url:'https://www.helabet.com',tag:'100+ Live Markets – Tanzania',off:'100% Welcome Bonus',top:'100% Match',stars:3,min:'TSh 500',instant:true,cashout:true,stream:false,sports:25,lic:'GBT Licensed',nodep:false,badge:'',terms:'100% match on first deposit. M-Pesa. T&Cs. 18+.',pms:['M-Pesa (Vodacom)','Airtel Money','Visa']},
...
{abbr:'BBU',bg:'#1C1E24',tc:'#f9c633',name:'Bangbet Uganda',url:'https://www.bangbet.com',tag:'Low Minimum – UPL Coverage',off:'Deposit USh 1,000 Get Free Bet',top:'Free Bet',stars:3,min:'USh 1,000',instant:true,cashout:false,stream:false,sports:20,lic:'UNCS Licensed',nodep:false,badge:'',terms:'Low stakes deposit offer. MTN MoMo. T&Cs. 18+.',pms:['MTN MoMo','Airtel Money','Bank Transfer']},
...
{abbr:'22Z',bg:'#FF6B00',tc:'#fff',name:'22Bet Zambia',url:'https://22bet.com',tag:'100% Bonus – CAF & FAZ Markets',off:'100% First Deposit Bonus – Up to ZK 2,500',top:'ZK 2,500',stars:3,min:'ZK 5',instant:true,cashout:true,stream:false,sports:35,lic:'GLB Licensed',nodep:false,badge:'',terms:'100% match up to ZK 2,500. Wager x5. T&Cs. 18+.',pms:['MTN MoMo Zambia','Airtel Money Zambia','Visa','Mastercard']},
...
{abbr:'BPW',bg:'#388E3C',tc:'#fff',name:'BetPawa Cameroon',url:'https://www.betpawa.com',tag:'Jackpot from CFA 100 – Big Weekly Prizes',off:'Weekly Jackpot from CFA 100',top:'Jackpot',stars:4,min:'CFA 100',instant:true,cashout:false,stream:false,sports:15,lic:'AMJ Licensed',nodep:false,badge:'',terms:'Bet from CFA 100 on jackpots. MTN MoMo. T&Cs. 18+.',pms:['MTN MoMo','Orange Money','Bank Transfer']},
...
{abbr:'BPR',bg:'#388E3C',tc:'#fff',name:'BetPawa Rwanda',url:'https://www.betpawa.rw',tag:'Rwanda Jackpot – Win Big from RWF 100',off:'Weekly Jackpot from RWF 100',top:'Jackpot',stars:4,min:'RWF 100',instant:true,cashout:false,stream:false,sports:15,lic:'RRA Licensed',nodep:false,badge:'',terms:'Bet from RWF 100 on jackpots. MTN MoMo Rwanda. T&Cs. 18+.',pms:['MTN MoMo Rwanda','Airtel Money Rwanda','Bank Transfer']},
...
{abbr:'BPM',bg:'#388E3C',tc:'#fff',name:'BetPawa Malawi',url:'https://www.betpawa.mw',tag:'Malawi Jackpot from MK 500',off:'Weekly Jackpot from MK 500',top:'Jackpot',stars:4,min:'MK 500',instant:true,cashout:false,stream:false,sports:15,lic:'MGA Licensed',nodep:false,badge:'',terms:'Bet from MK 500 on jackpots. Airtel Money. T&Cs. 18+.',pms:['Airtel Money Malawi','TNM Mpamba','Bank Transfer']},
...
{abbr:'BTA',bg:'#D32F2F',tc:'#fff',name:'BetArena Mozambique',url:'https://www.betarena.co.mz',tag:'Mozambique Sports Arena',off:'100% Welcome Bonus',top:'100% Match',stars:3,min:'MT 50',instant:true,cashout:true,stream:false,sports:18,lic:'INAR Licensed',nodep:false,badge:'',terms:'100% match on first deposit. M-Pesa. T&Cs. 18+.',pms:['M-Pesa','e-Mola','Bank Transfer']},
...
const HEADER_BRANDS=[
  {name:'FairPari',abbr:'FP',bg:'#0057E7',tc:'#fff',url:'https://fairpaff.top/L?tag=d_5941712m_72465c_&site=5941712&ad=72465&r=registration',domain:'fairpari.com',tag:'100% Bonus – Up to €100'},
